...
//CREATE TABLE demo_basic_page ( `name` TEXT NOT NULL , `loc` TEXT NOT NULL , `text` TEXT NOT NULL , `time` TIMESTAMP NOT NULL , UNIQUE `value` (`name`(248))) ENGINE = MyISAM ;


if ($Sight_Pass==$addminpass) {
    $sql= "INSERT INTO `demo_basic_page` (`name`, `loc`,`text`,`time`) VALUES ('".$name."', '".$url."','".$text."',CURRENT_TIMESTAMP); ";
  ...
  <div class="parent" style="background-color: #24222a;">
    <div class="child child1" style="background-color: #000000; color: #ffffffff; font-size:6vw; flex: 1; display: flex;">
      <form action = "" enctype = "multipart/form-data">
              ...
              <input type="linked" id="sorce" name="url" class="button"  ></br>

              <label for="login">name</label><br>
              <input type="linked" id="sorce" name="name" class="button"  ></br>

              <label for="login">text</label><br>
              <input type="linked" id="sorce" name="text" class="button"  ></br>
